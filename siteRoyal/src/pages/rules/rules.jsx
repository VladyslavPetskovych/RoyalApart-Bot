    ...
    <div className="pt-28 flex flex-col items-start justify-start">
      ...
      <div className="bg-back">
        ...
        >
          <ul className="p-4">
            <li>
            • Адміністратор відправить Вам інструкцію самостійного поселення
            </li>
          </ul>
        </Dropdown>
        <Dropdown
          title="Штрафи і правила"
          index={2}
          openIndex={openIndex}
          setOpenIndex={setOpenIndex}
        >
          <ul className="p-4">
            <li>• Клієнт несе повну матеріальну відповідальність за пошкоджене майно! </li>
            <li>• Заборонено порушувати спокій після 22:00 - штраф 2500грн або негайне виселення</li>
            <li>• Куріння заборонено - штраф - 2500грн </li>
            <li>• Доплата за проживання з тваринкою обговорюється та оплачується додатково 
              (700 грн за весь період), при самовільному проживанні діє штраф 2500 грн. 
            </li>
          </ul>
        </Dropdown>
        <Dropdown
        ...
        >
          <ul className="p-4">
            ...
            <li>– кредитною карткою (в офісі)</li>
            <li>– готівкою</li>
