      ...
      <div className="bg-back">
        ...
        >
          <ul className="p-4">
            ...
            <li>• Заборонено порушувати спокій після 21:00 - штраф 2500грн або негайне виселення</li>
            <li>• Куріння заборонено - штраф - 2500грн </li>
            <li>• Доплата за проивання з тваринкою обговорюється та оплачується додатково 
